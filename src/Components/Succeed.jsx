      ...
      <h2 className='lg:text-6xl text-5xl text-white text-center'>Everything you need to succeed</h2>
        <div className="flex flex-col lg:flex-row justify-between pt-14 gap-y-8 lg:gap-y-0">
            {succeed.map((item, index)=>(
                <div key={index} className="rounded-[50px] bg-[rgba(24,24,27,0.8)] backdrop:blur-xl border border-zinc-700 p-8 py-14 text-center basis-[23.5%]" data-aos="fade-left">
        ...
        <div className="flex flex-col lg:flex-row lg:pt-[10%] pt-[20%] justify-between items-center gap-y-8 lg:gap-y-0">
            <div className="basis-[45%]" data-aos="fade-right">
                ...
                <Link to="/Signup"><button className='rounded-xl bg-[#d68bfb] px-6 py-4 text-zinc-900 text-lg font-medium lg:mt-7 '>Sign up for free</button></Link>
            </div>
            </div>
        ...
        <div className='lg:pt-[10%] pt-[20%]'>
            ...
            {testimonials.map((item, index)=>(
                <SwiperSlide className='text-white lg:px-[10%]' key={index}>
                    <div className="rounded-[50px] p-4 bg-[rgba(24,24,27,0.8)] backdrop:blur-xl border border-zinc-700 flex flex-col-reverse lg:flex-row-reverse justify-between items-stretch">
        ...
        <div className="flex gap-x-6 justify-center pt-[4%] lg:pb-[5%] pb-[20%]">
            ...
            <button className='rounded-xl bg-[rgba(24,24,27,0.8)] backdrop:blur-xl text-[#d68bfb] border border-zinc-700 font-medium px-6 py-3 lg:text-xl text-xs'>Learn more</button>
        </div>
